...
let path = {
	build: {
		html: 'exchange/www/',
		css: 'exchange/www/css/',
		js: 'exchange/www/js/',
		img: 'exchange/www/img/',
		fonts: 'exchange/www/fonts/'
	},
	src: {
		html: 'exchange/src/*.html',
		css: 'exchange/src/css/style.css',
		js: 'exchange/src/js/app.js',
		img: 'exchange/src/img/**/*.*',
		fonts: 'exchange/src/fonts/**/*.*'
	},
	watch: {
		html: 'exchange/src/**/*.html',
		css: 'exchange/src/css/**/*.css',
		js: 'exchange/src/js/**/*.js',
		img: 'exchange/src/img/**/*.*',
		fonts: 'exchange/src/fonts/**/*.*'
	},
	clean: './exchange/www'
